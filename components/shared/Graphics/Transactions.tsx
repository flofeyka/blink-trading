...
export default function Transactions({address, direction}: { address: string, direction: number }) {
    ...
    const tabs: TabItem[] = [{
        id: "transactions", label: "Transactions", icon: "/icons/transactions.svg",
    }, {
        id: "holdings", label: "My Holdings", icon: "/icons/holdings.svg",
    }, {
        id: "traders", label: "Top Traders", icon: "/icons/traders.svg",
    }, {
        id: "holders", label: "Holders (12272)", icon: "/icons/holders.svg",
    }, {
    ...
    const holders: Holder[] = [{
        wallet: "2hs...3dn", owned: "16.00%", amount: "160M", value: "$3.4k",
    }, {
        wallet: "3ju...2te", owned: "15.00%", amount: "150M", value: "$3.4k",
    }, {
        wallet: "5hg...2bn", owned: "15.00%", amount: "150M", value: "$3.4k",
    }, {
        wallet: "7hy...2bn", owned: "15.00%", amount: "150M", value: "$3.4k",
    }, {
        wallet: "9ks...2tn", owned: "15.00%", amount: "150M", value: "$3.4k",
    },];
    ...
    const transactionColumns: Column<Transaction>[] = [{
        header: (<div className="flex items-center gap-2">
                <div className="rounded-xl overflow-hidden border border-[#353535] flex">
                    <button
                        className={`text-xs px-5 py-1.5 cursor-pointer ${dateViewMode === "date" ? "text-white bg-[#353535]" : "text-[#A9A9A9]"}`}
                        onClick={() => setDateViewMode("date")}
                    >
                        DATE
                    </button>
                    <button
                        className={`text-xs px-5 py-1.5 cursor-pointer ${dateViewMode === "age" ? "text-white bg-[#353535]" : "text-[#A9A9A9]"}`}
        ...
        minWidth: "160px",
        width: "160px",
        render: (value) => (<span className="text-[#00C1E7] flex gap-1 items-center">
          <Image
        ...
        minWidth: "60px",
        width: "60px",
        render: (value) => (<Link href={`http://solscan.io/tx/${value}`} className="flex justify-end gap-2">
                {/* <Image
            src="/icons/copy.svg"
            width={15}
            height={15}
    ...
    const holdingColumns: Column<Holding>[] = [{
        ...
        render: (value, row) => (<div className="flex items-center gap-2">
                <Image
                    ...
                    alt="token"
                />
                <Image src={row.image} className="w-6 h-6 bg-[#D9D9D9] rounded-full" width={30} height={30}
                       alt={"coin"}/>
        ...
        width: "175px",
        render: () => (<Button
                className="bg-linear-to-r from-[#F43500] to-[#AA1013] flex items-center justify-center font-semibold w-full gap-2.5 min-w-[150px]">
                QUICK SELL
            </Button>),
    },];
    ...
    const traderColumns: Column<Trader>[] = [{
        ...
        minWidth: "120px",
        width: "120px",
        render: (value) => (<div className="flex items-center gap-1">
                <Image
                    src="/icons/profile.svg"
                    width={30}
                    height={30}
        ...
        header: "SOLD", key: "sold", align: "left", minWidth: "100px", width: "100px", render: (value, row) => (<div>
        ...
        header: "BALANCE", key: "balance", align: "left", minWidth: "200px", width: "200px", render: (value, row) => {
        ...
        minWidth: "60px",
        width: "60px",
        render: (value) => (<Image src="/icons/sort.svg" width={20} height={20} alt="menu"/>),
    },];
    ...
    const holderColumns: Column<Holder>[] = [{
        ...
        minWidth: "60px",
        width: "60px",
        render: () => (<Image src="/icons/sort.svg" width={25} height={25} alt="menu"/>),
    },];
    ...
    const renderTable = () => {
        switch (activeTab) {
            case "transactions":
                return (transactionData.length ? <Table
            ...
            case "holders":
                return (<Table
                    ...
                    />);
            case "orders":
                return (<div className="text-center py-4 text-[#A9A9A9]">
                        No active orders
                    </div>);
            default:
                return null;
    ...
    return (<div className="bg-[#202020] p-2 rounded-b-md  max-md:hidden">
            {/* Tabs */}
            <div className="flex gap-4 border-b border-[#353535] overflow-x-auto" style={{
                scrollbarWidth: "thin", scrollbarColor: "#444 #222",
            }}>
                {tabs.map((tab) => (<span
                        key={tab.id}
                        className={`cursor-pointer px-2 pb-2 whitespace-nowrap flex items-center gap-2 ${activeTab === tab.id ? "text-white border-b-2 border-[#AEFF00]" : "text-[#A9A9A9]"}`}
